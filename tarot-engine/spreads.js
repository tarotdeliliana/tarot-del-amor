...
// La orientación se decide por mazo, nunca por la IA.
...
const SPREAD_RULES = {
  ...
  loversPath: { deck: 'Tarot del Amor', type: 'Tirada del Amor', count: 13, allowReversed: true, positions: LOVERS_PATH_13 }
};
